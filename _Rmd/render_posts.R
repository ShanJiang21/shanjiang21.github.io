# render_post.R
# To serve the render of posts using Rmarkdown and Jekyll 
...
KnitPost <- function(site.path='/Users/johnsonpie/Documents/GitHub/shanjiang21.github.io/', 
...
fig.dir <- "img/" # directory to save figures
posts.path <- paste0(site.path, "_posts") # directory for converted markdown files
cache.path <- paste0(site.path, "_cache") # necessary for plots in a new Cache folder
